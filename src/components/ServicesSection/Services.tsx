...
export default function ServicesSection () {
    return (
        <section id="services" className="flex flex-col h-fit gap-12 items-center justify-center px-[7.5vw] lg:px-[12.5vw] py-24 scroll-mt-[80px]">
            ...
            <div className="flex flex-col gap-8 w-full items-stretch lg:flex-row">
