...
export default function Footer () {
    return (
        <footer className="pt-[2rem] w-full flex flex-col bg-background text-text-invert text-sm">
            <div className="flex flex-col items-center lg:items-start lg:flex-row w-full px-[12.5vw] text-text pb-16 gap-12 lg:gap-32">
                <div className="flex flex-col flex-1 gap-8 items-center lg:items-start">
                    ...
                    <p className="opacity-75 text-center lg:text-start">                 
                ...
                <div className="flex flex-col gap-2 flex-1 items-center lg:items-start">
            ...
            <div className="flex flex-col gap-4 lg:gap-0 items-center lg:items-start lg:flex-row w-full px-[12.5vw] py-6 justify-between bg-black text-text">
                <div className="opacity-75 text-center lg:text-start">
