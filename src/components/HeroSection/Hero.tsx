...
export default async function HeroSection () {
    ...
    return (
        <section className="w-full h-[calc(100vh-116px)] z-10 relative flex justify-center items-center pb-[116px] px-[7.5vw]">
            ...
            <div className="flex flex-col justify-center items-center">
                <h1 className="text-6xl text-center font-bold mb-4 tracking-[3px]">Painting & Decoration</h1>
                <p className="mb-8 text-base lg:text-xl text-center tracking-[1px]">Painting & Decoration services for your house and apartment!</p>
                <Link href='/#contacts'
